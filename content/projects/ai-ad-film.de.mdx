...
<div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'12px',margin:'16px 0'}}>
  <div>
    <img src="/projects/kimuva/cafe-door-before.jpg" alt="Café-Tür – Entwurf" style={{width:'100%',height:'420px',objectFit:'cover'}} />
    <p style={{fontSize:'12px',color:'var(--tm)',margin:'6px 0 0',textAlign:'center',fontWeight:500}}>Entwurf</p>
  </div>
  <div>
    <img src="/projects/kimuva/cafe-door-after.jpg" alt="Café-Tür – verbesserte Version" style={{width:'100%',height:'420px',objectFit:'cover'}} />
    <p style={{fontSize:'12px',color:'var(--tm)',margin:'6px 0 0',textAlign:'center',fontWeight:500}}>Verbesserte Version</p>
  </div>
</div>
...
<video controls style={{width:'100%',borderRadius:'8px',margin:'16px 0'}}>
  <source src="/projects/kimuva/kimuva-werbefilm.mp4" type="video/mp4" />
</video>
