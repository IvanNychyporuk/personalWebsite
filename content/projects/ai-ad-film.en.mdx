...
<div style={{display:'grid',gridTemplateColumns:'1fr 1.2fr 1fr',gap:'24px',margin:'16px 0',alignItems:'center'}}>
  <img src="/projects/kimuva/character-01.jpg" alt="Character reference – Mila, portrait 1" style={{width:'100%'}} />
  ...
  <img src="/projects/kimuva/character-02.jpg" alt="Character reference – Mila, portrait 2" style={{width:'100%'}} />
</div>
...
<div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'12px',margin:'16px 0'}}>
  <div>
    <img src="/projects/kimuva/cafe-door-before.jpg" alt="Café door – draft" style={{width:'100%',height:'420px',objectFit:'cover'}} />
    <p style={{fontSize:'12px',color:'var(--tm)',margin:'6px 0 0',textAlign:'center',fontWeight:500}}>Draft</p>
  </div>
  <div>
    <img src="/projects/kimuva/cafe-door-after.jpg" alt="Café door – improved version" style={{width:'100%',height:'420px',objectFit:'cover'}} />
    <p style={{fontSize:'12px',color:'var(--tm)',margin:'6px 0 0',textAlign:'center',fontWeight:500}}>Improved version</p>
  </div>
</div>
